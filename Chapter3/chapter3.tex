...
\subsection{Lineages and Connectivity} 
%Lineages
...
None of these lineages are exclusive contributors to the Larval CX - i.e al of these lineages contribute neurons to other parts of the brain - however there are a few that contribute more than a fifts (20\%) of their neurons to CX neuropils (Figure (\ref{cx_percentage})). %TODO add table with top percentages 

% Subtle forest green gradient (Excel-style)
\definecolor{forest1}{HTML}{EAF2E3} % lightest
\definecolor{forest2}{HTML}{D7E8C9}
\definecolor{forest3}{HTML}{B9D89C}
\definecolor{forest4}{HTML}{93C47D}
\definecolor{forest5}{HTML}{6AA84F} % darkest
...
%Connectivity with other neuropils  accessory structures
...
\section{Behavioural Assays - Loss of Function Analysis during light stimulation}
    \begin{figure}
        \centering
        \includegraphics[width=12cm]{Figs/CX/BehaviourAssays_paper.pdf}
...
\section{Neural activity in response to blue light stimulation}
    \begin{figure}
        \centering
        \includegraphics[width=12cm]{Figs/CX/RH5stimulation.pdf}

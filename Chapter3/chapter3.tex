...
Upon blue light stimulation, we observed robust calcium transients in multiple regions of the larval brain. We expected the neuropil with the most visual input (Protocerebral Bridge) to be highly responsive. To identify regions of interest  that have been activated in resoponse to light, the brain was segmented into distinct anatomical regions using manual annotation. Regions corresponding to the optic lobe (OL)- to confirm its light induced activity - the putative Protocerebral Bridge, and the MB as a control  and the Optic Lobe - were delinated based on anatomical landmarks and lineage tracing data. Fluorescence intensity changes (ΔF/F) were quantified for each region during blue light stimulation, revealing that


the Protocerebral Bridge exhibited the highest amplitude calcium transients, consistent with its role as the primary recipient of visual input. Other central complex neuropils also showed significant activity, supporting their involvement in sensory processing. These results demonstrate that the identified central complex structures are functionally responsive to visual stimulation and validate their anatomical assignment.

...
\section{Strategy for ientifying central complex neuropils in the larval brain}

\section{Lineages of the Central Complex}
    Summary of which neurons do we expect to find in each lineage.which neurons match the pattern of being a cx neuron, and which lineage do they belong to and see if they match the adult. 
    %ask Yijie fafb lineage for cx neurons

...
\section{Strategy for identifying CX neuropils in the larval brain}
    ...
    I found several neurons that satisfied said criteria, and were therefore classified as central complex neurons  Section \ref{CXLarva}). A comprehensive list of their lineages as well as the above lineages is shown in Table \ref{larvallineages}. 

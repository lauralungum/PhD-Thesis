...
\end{table}
    ...
    Wedge neurons, like the adult, receive further axo-axonic synapses from Ring neurons (see below; RN1/2, also known as FBN-20; and RN3).
        ...
        \subsubsection{EB Ring Neurons and EB Wedge Neurons connectivity}
...
\section{Mushroom Body and the larval CX}
    ...
    \subsection{A loop between FB and the 'c' compartment of the MB}
    ...
    \subsection{A loop between the NO and the MB vertical lobe via LAL}
